...
// request context (ADR-0005 P2.2d).
//
// Usage:
//
...
// delegating to the wrapped handler. The two trace attributes are added so
// they appear in the structured log record for easy grepping.
